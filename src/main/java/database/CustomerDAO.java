...
import database.util.DataAccessObject;
...
public class CustomerDAO extends DataAccessObject<Customer> {
    ...
    private static final String INSERT_ONE = "INSERT INTO CUSTOMER (first_name, last_name, email, phone," + " address, city, state, zipcode) VALUES (?,?,?,?,?,?,?,?)";
    ...
    public Customer create(Customer dto) {
        try(PreparedStatement statement = this.connection.prepareStatement(INSERT_ONE)){
            statement.setString(1, dto.getFirstName());
            statement.setString(2, dto.getLastName());
            statement.setString(3, dto.getEmail());
            statement.setString(4, dto.getPhone());
